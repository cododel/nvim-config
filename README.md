...
Внутри дерева `h` сворачивает текущую директорию, `l` раскрывает выбранную директорию только на один уровень и повторно не сворачивает её. `Enter` делает директорию новым root, а выбранный файл открывает в editor.
